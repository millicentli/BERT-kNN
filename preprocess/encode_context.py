...
def main(num_dump, batch_size=124):
    input_param = {
        "lm": "bert",
        "label": "bert_base",
        "models_names": ["bert"],
    ...
    data_file = "/private/home/millicentli/BERT-kNN/DrQA/data/test_multimasking_stuff/test_multimasking_batched/dump_"
    # save_dir = "/private/home/millicentli/BERT-kNN/DrQA/data/vectors/"
    save_dir = "/private/home/millicentli/BERT-kNN/DrQA/data/test_multimasking_stuff/vectors/"
...
if __name__ == "__main__":
    ...
    main(args.dump, args.batch_size)
